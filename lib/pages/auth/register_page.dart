...
class _RegisterPageState extends State<RegisterPage>
  ...
  try {
    // Đăng ký trực tiếp, không qua OTP
    ...
    // Chuyển đến màn hình thông báo thay vì OTP
  ...
  Widget _buildHeader(BuildContext context) {
    return Column(
      children: [
        ...
        const Text(
          'Nhập thông tin, tạo mật khẩu và xác nhận email để vào thẳng ứng dụng.', // MỚI
    ...
    return Row(
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: const Text(
            'Đăng nhập',
            style: TextStyle(color: kAuthAccent, fontSize: 14, fontWeight: FontWeight.w700),
          ),
        ),
      ],
    );
