...
class _RegisterPageState extends State<RegisterPage>
  ...
  // ── Helper: lỗi Firebase → tiếng Việt ─────────────────────────────────────
  ...
  String _friendlyError(String code) {
    switch (code) {
      ...
      case 'too-many-requests':
        return 'Quá nhiều yêu cầu. Thử lại sau ít phút';
      default:
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      // 3️⃣ Lưu vào Firestore (không block navigation nếu lỗi)
      try {
        ...
        // Firestore lỗi không sao, Auth đã tạo thành công
      }
      ...
      // 4️⃣ Về HomePage, xóa toàn bộ stack
  ...
  Widget _buildHeader(BuildContext context) {
    return Column(
      children: [
        ...
        const Text(
          'Tham gia để trải nghiệm âm nhạc không giới hạn',
            ...
            text: const TextSpan(
              ...
              children: [
                ...
                TextSpan(
                  ...
                  style: TextStyle(
                      color: kAuthAccent, fontWeight: FontWeight.w600),
                ),
                TextSpan(text: ' và '),
                TextSpan(
